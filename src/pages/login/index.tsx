            ...
            <div className="flex min-h-screen items-center justify-center ">
                <div className="flex flex-col md:flex-row w-full m-6 max-w-4xl bg-white shadow-md rounded-lg overflow-hidden">
                    ...
                    <div className="w-full md:w-1/2 px-8 pb-24 pt-3 md:pt-24  md:px-16">
                        ...
                        <h2 className="text-2xl text-center font-bold mb-6 text-gray-900">Login</h2>
                        <Form
                            name="login"
                        ...
                        >
                            ...
                            <Form.Item name="remember" valuePropName="checked" className="flex items-center font-bold">
                        ...
                        <div className='text-center py-2'>
                            <span className='text-sm'>
                                ...
                                <Link href="/register" className='text-cyan-600 font-medium hover:underline'> Sign up</Link>
                            </span>
                        </div>
                    </div>
